...
class ResNetManager():
    def __init__(self, cmd_args):
        ...
        self.hyper_batch_norm_config = cmd_args.hyper_batch_norm

        self.model = ResNet18(10,
                              self.hyper_layers, self.hyper_batch_norm_config, self.device)
    ...
    def test_task(self, dataloader, task_embedding):
        ...
        for i, batch in enumerate(dataloader):
            ...
            output = self.model(pixels, predicted_weights, task_embedding)
